        ...
        <div className="flex flex-col gap-oneFourty  ">
          {
            ImgCards.map((item, index) => (
              <ImgCard key={index} imgSrc={item.ImgSrc} altTxt={item.alt} ImagePosX={item.posX} paraTxt={item.paraTxt} heading={item.heaingTxt} subheadingTxt={item.subHeadingTxt} height={item.height} width={item.width} />
            ))
          }
